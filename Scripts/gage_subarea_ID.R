...
# Look at differences with previous ID to EArea file
...
#   5 pseudo-gages hand-selected from EDEN_v3 development process
...
#          as found in: 20170710_median_Ex


# Using the downloaded gage file from the website as the base
# So if changes are made in the future to names/coordinates, can just redownload
...
# -----------------------------------------------------------------------------
# Add EArea for 15 additional gauges

# make sure that EArea and Location Area are the same
...
# -----------------------------------------------------------------------------
# Add column for each subzone & classify
...
# Add something here that susm up the subzone columns, if == 0, then other = 1
