...
# THESE FUNCTIONS REQUIRE THE FILES IN THE 'DATA' FOLDER TO RUN 

# THE INTERPOLATION HERE IS A REPRODUCTION OF 'ALTEDEN_RUN3_TRIAL2_V7.R'
...
interpolate_gauges <- function(gages){
...
##### 6 - FUNCTION TO RUN RBF INTEROPLATION OF GAUGES & EXPORT CSV #### --------
# Output: CSV interpolation of water level (stage) in same units as input
